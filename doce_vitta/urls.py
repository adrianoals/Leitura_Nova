...
from doce_vitta.views import doce_vitta, doce_vitta_ok, doce_vitta_erro, dv_download_photos, DownloadExcelView
...
urlpatterns = [
        ...
        path('dv-excel/', DownloadExcelView.as_view(), name='dv-excel'),
]
